...
function getTheme(mode) {
  ...
  for (const key in filterColors) {
    oklchPalette.filters[key] =
      mode === "dark" ? filterColors[key].dark : filterColors[key].light;
  }
...
export default function AppProviders({ children }) {
  ...
  useEffect(() => {
    ...
    console.log(
      "AppProviders: NEXT_PUBLIC_DISABLE_AUTH =",
    ...
    if (isAuthDisabled) {
      console.log(
        "AppProviders: Auth disabled via env var, setting state to unauthenticated"
      );
